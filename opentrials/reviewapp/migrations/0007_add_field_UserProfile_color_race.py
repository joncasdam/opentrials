...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.color_race'
        db.add_column('reviewapp_userprofile', 'color_race',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.color_race'
        db.delete_column('reviewapp_userprofile', 'color_race')
    ...
    models = {
        ...
        'repository.contact': {
            'Meta': {'ordering': "['firstname', 'middlename', 'lastname']", 'object_name': 'Contact'},
            '_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
        ...
        'reviewapp.attachment': {
            ...
            'attach_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'reviewapp.userprofile': {
            ...
            'color_race': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '2'}),
            'genre': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
